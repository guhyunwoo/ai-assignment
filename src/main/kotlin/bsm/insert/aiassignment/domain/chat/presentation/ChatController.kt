package bsm.insert.aiassignment.domain.chat.presentation
...
import bsm.insert.aiassignment.domain.chat.application.service.ChatService
...
class ChatController(
    ...
    fun createChat(
        ...
        return if (request.isStreaming) {
            ...
            executor.execute {
                try {
                    val (chatId, flow) = chatService.createStreamingChat(request, authUserDetails)
            ...
            val response = chatService.createChat(request, authUserDetails)
    ...
    fun getThreads(
        ...
        val response = chatService.getThreads(authUserDetails, page, size, sort)
    ...
    fun deleteThread(
        ...
        chatService.deleteThread(threadId, authUserDetails)
